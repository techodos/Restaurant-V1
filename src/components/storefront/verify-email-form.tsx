...
import { sendVerificationCodeAction, verifyEmailCodeAction } from "@/app/r/[restaurantSlug]/account/actions";
 ...
 */
export function VerifyEmailForm({ restaurantSlug, onVerified }: { restaurantSlug: string; onVerified?: () => void }) {
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-3">
      <div className="space-y-1.5">
        ...
        />
        <FieldHint>Enter the 6-digit code we emailed you. It expires in 10 minutes.</FieldHint>
